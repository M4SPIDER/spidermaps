            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.045] p-7 shadow-[0_20px_80px_rgba(0,0,0,0.18)] md:p-10">
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-2">
                ...
                <div className="lift-card flex flex-col justify-between rounded-[1.8rem] border border-white/10 bg-white/[0.045] p-6">
                  ...
                  <div className="mt-8 pt-4 border-t border-white/10">
                    <a
                      href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent('〒110-0005 Tokyo, Taito City, Ueno, 3-20-2 Mizuno building B')}`}
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              <div className="mt-8 overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950 shadow-2xl">
                ...
                <div className="relative aspect-[16/9] w-full min-h-[380px] md:min-h-[440px]">
                  <iframe
                    src={`https://maps.google.com/maps?q=${encodeURIComponent('3-20-2 Ueno, Taito City, Tokyo 110-0005 Japan')}&t=&z=16&ie=UTF8&iwloc=&output=embed`}
